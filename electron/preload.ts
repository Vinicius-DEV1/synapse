...
contextBridge.exposeInMainWorld('api', {
  ...
  updatePage: (page: { id: string; title?: string; icon?: string; content?: string; crdt_state?: string | null; parent_id?: string | null; cover_image?: string | null; description?: string | null }) =>
