          ...
          <div key={card.note_id} className={`bg-dark-card border rounded-2xl p-5 flex flex-col hover:shadow-2xl transition-all ${isSelected ? 'border-indigo-500 shadow-[0_0_15px_rgba(99,102,241,0.2)]' : 'border-white/5 hover:border-white/20'}`}>
            ...
            <div className="flex-1 flex flex-col gap-4">
              <div>
                ...
                <HtmlRenderer html={card.front} className="text-sm text-dark-text whitespace-pre-wrap leading-relaxed overflow-y-auto custom-scrollbar max-h-48 block" />
              </div>
              ...
              <div>
                ...
                <HtmlRenderer html={card.back} className="text-sm text-dark-subtext whitespace-pre-wrap leading-relaxed overflow-y-auto custom-scrollbar max-h-48 block" />
              </div>
            </div>
          </div>
        );
