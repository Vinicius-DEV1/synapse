  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
        {/* Total Questions */}
        <div className="bg-zinc-900/60 border border-white/[0.08] rounded-2xl p-4 flex flex-col justify-between">
          ...
          <div className="mt-3 flex items-baseline gap-2">
            <span className="text-2xl sm:text-3xl font-bold text-zinc-100 font-mono">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="p-5 rounded-2xl bg-rose-500/[0.04] border border-rose-500/20 hover:border-rose-500/35 transition-all flex flex-col justify-between">
        ...
        <div className="p-5 rounded-2xl bg-brand-500/[0.04] border border-brand-500/20 hover:border-brand-500/35 transition-all flex flex-col justify-between">
          ...
          <div className="mt-4 flex items-center justify-end gap-2">
            <button
              ...
              className="px-4 py-2 rounded-xl bg-brand-600 hover:bg-brand-500 text-white text-xs font-semibold flex items-center gap-1.5 transition-all cursor-pointer disabled:opacity-40 shadow-xs"
            >
      ...
      <div className="bg-zinc-900/60 border border-white/[0.08] rounded-2xl p-5 space-y-4">
          ...
          <div className="space-y-3">
            {sortedTags.map(([tag, tStat]) => {
              ...
              return (
                <div
                  key={tag}
                  className="p-3 rounded-xl bg-zinc-900/80 border border-white/[0.04] flex flex-col sm:flex-row sm:items-center justify-between gap-3 hover:border-white/10 transition-colors"
                >
