...
Retorne estritamente um objeto JSON com a seguinte estrutura:
{
  ...
  "english": {
    ...
    "anki_card": {
      "front": "${pageContext ? 'Junte as legendas do Contexto fornecido para formar APENAS UMA ÚNICA FRASE completa (lógica e coesa) que contém a palavra. Ignore trechos soltos ou fragmentos da próxima frase. NÃO INVENTE OUTRA FRASE.' : 'Frase de contexto com a palavra-alvo. (Ex: She is a brilliant scientist.)'}",
...
Retorne estritamente um objeto JSON com a seguinte estrutura:
{
  ...
  "portuguese": {
    ...
    "anki_card": {
      "front": "${pageContext ? 'Junte as legendas do Contexto fornecido para formar APENAS UMA ÚNICA FRASE completa (lógica e coesa) que contém a palavra. Ignore trechos soltos ou fragmentos da próxima frase. NÃO INVENTE OUTRA FRASE.' : 'Frase de contexto com a palavra-alvo.'}",
