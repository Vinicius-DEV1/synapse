...
import { alignToClass, normalizeAlign, safePos } from './imageUtils';
...
export const EncryptedImageNodeView = (props: NodeViewProps) => {
  ...
  // Loads and decrypts the image from Google Drive, or uploads if it's newly pasted
  const loadImage = useCallback(async () => {
    ...
    try {
      ...
      if (driveFileId.startsWith('uploading_')) {
        ...
        // If page was reloaded and file in memory was lost, recover from cache
        if (!file) {
